...
set SCRIPT_PATH=D:\Proyectos\4_BI_Ecom\Promociones Magento\magento_reglas_precio.py
set LOG_FILE=D:\Proyectos\4_BI_Ecom\Logs\magento_reglas_precio.log
...
cd /d "D:\Proyectos\4_BI_Ecom\Promociones Magento"
